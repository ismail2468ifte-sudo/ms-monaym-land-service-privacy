...
fun ServicesScreen(
    ...
    Scaffold(
        topBar = {
            TopAppBar(
                title = { Text("সরকারি অনলাইন ভূমি সেবা", fontWeight = FontWeight.Bold, color = Color.White) },
                navigationIcon = {
        ...
        Column(
            ...
            Surface(
                ...
                Row(
                    ...
                    Icon(Icons.Default.Language, contentDescription = null, tint = LandGreenPrimary, modifier = Modifier.size(28.dp))
                    Spacer(modifier = Modifier.width(10.dp))
                    Text(
                        text = "গণপ্রজাতন্ত্রী বাংলাদেশ সরকারের সকল অনলাইন ডিজিটাল ভূমি সেবা পোর্টাল",
                        fontSize = 13.sp,
                        color = LandGreenDark,
                        ...
                        Column(modifier = Modifier.padding(16.dp)) {
                            Row(
                                ...
                                Button(
                                    ...
                                    Text("প্রবেশ", fontSize = 12.sp, fontWeight = FontWeight.Bold)
